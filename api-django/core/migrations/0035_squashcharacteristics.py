...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('core', '0034_soybeancharacteristics'),
    ]

    operations = [
        migrations.CreateModel(
            name='SquashCharacteristics',
            fields=[
                ...
                ('photo', models.ImageField(blank=True, null=True, upload_to='squash_characteristics/')),
                ('notes', models.TextField(blank=True, null=True)),
                ('createdAt', models.DateTimeField(auto_now_add=True)),
                ('updatedAt', models.DateTimeField(auto_now=True)),
                ('passportData', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='squash_characteristics', to='core.passportdata')),
            ],
        ),
    ]
