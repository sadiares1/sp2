...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('core', '0021_limabeancharacteristics'),
    ]

    operations = [
        migrations.CreateModel(
            name='LuffaCharacteristics',
            fields=[
                ...
                ('fruit_skin_thickness_mm', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True)),
                ...
                ('photo', models.ImageField(blank=True, null=True, upload_to='luffa_characteristics/')),
                ('notes', models.TextField(blank=True, null=True)),
                ('createdAt', models.DateTimeField(auto_now_add=True)),
                ('updatedAt', models.DateTimeField(auto_now=True)),
                ('passportData', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='luffa_characteristics', to='core.passportdata')),
            ],
        ),
    ]
